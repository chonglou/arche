...
class Widget extends Component {
  ...
  componentDidMount() {
    ...
    if (id) {
      get(`/api/donate/projects/${id}`).then((rst) => {
      ...
      <Row>
        <Col md={{
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <FormItem {...formItemLayout} label={<FormattedMessage id = "donate.attributes.project.methods" />} hasFeedback={true}>
              {
