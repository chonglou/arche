...
func LunarToSolar(lunar Lunar) *Solar {
	...
	var solar11 = solar1_1[lunar.LunarYear-solar1_1[0]]
...
func SolarToLunar(solar Solar) *Lunar {
	lunar := &Lunar{}
	var index = solar.SolarYear - solar1_1[0]
	var data = (solar.SolarYear << 9) | (solar.SolarMonth << 5) | (solar.SolarDay)
	var solar11 int
	if solar1_1[index] > data {
		index--
	}
	solar11 = solar1_1[index]
	var y = getBitInt(solar11, 12, 9)
	var m = getBitInt(solar11, 4, 5)
	var d = getBitInt(solar11, 5, 0)
	var offset = int(solarToInt(solar.SolarYear, solar.SolarMonth, solar.SolarDay) - solarToInt(y, m, d))

	var days = lunarMonthDays[index]
	var leap = getBitInt(days, 4, 13)

	var lunarY = index + solar1_1[0]
	var lunarM = 1
	var lunarD int
	offset++
